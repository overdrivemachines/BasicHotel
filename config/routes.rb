...
#                property_rooms GET    /properties/:property_id/rooms(.:format)          rooms#index
#                               POST   /properties/:property_id/rooms(.:format)          rooms#create
#             new_property_room GET    /properties/:property_id/rooms/new(.:format)      rooms#new
